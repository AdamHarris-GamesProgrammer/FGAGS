...
{
public:
	static unsigned SphereAndHalfSpace(const Sphere& sphere,const CollisionPlane& plane,CollisionData* data);
	...
	static unsigned BoxAndHalfSpace(const Box& box,const CollisionPlane& plane,CollisionData* data);
